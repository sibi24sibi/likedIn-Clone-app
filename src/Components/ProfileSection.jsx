  ...
  return (
    <>
      <div className='bg-gray-100 h-auto max-w-max rounded-xl my-10 ml-20 flex flex-col border border-grey'>
        <img className='relative h-[210px] w-[770px] rounded-t-xl object-cover' src='src\assets\images\cover2.webp' alt='cover-photo' />
        <div>
          <img className='absolute top-[10rem] left-[7rem] h-[155px] w-[155px] rounded-full border-2 border-white object-cover' src='src\assets\images\anime.webp' alt='profile pic'/>
        </div>
        ...
        <div className='flex justify-between p-1'>
          <div className='ml-6 mt-7 flex flex-col'>
            ...
            <div className='flex gap-1 justify-start items-center'>
              ...
              <a href='/' className='text-[14px] text-sky-600 font-medium'>Contact info</a>
            </div>
        ...
        <div className='flex justify-between ml-6 my-2 mb-4'>
          <button className='flex gap-1 justify-center items-center bg-blue-500 rounded-lg text-white font-medium p-2 w-24 hover:bg-blue-950' type='button'>
            <FiPlusCircle />
              <p className='text-sm'>Connect</p>
          </button>
          <button className='flex gap-1 justify-center items-center bg-blue-500 rounded-lg text-white font-medium p-2 w-20 hover:bg-blue-950 mr-6' type='button' onClick={() => setOpen(true)}>
            <FaPencilAlt />
