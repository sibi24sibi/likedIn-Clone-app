...
function PostModel({
  loadingMore, loading, postData, userDetails, isOwnProfile, onDelete
        ...
        postData.length === 0 ? (
          ...
          (
            postData.map((post) => (
              <div
                key={post.id}
                className='bg-white rounded-lg max-w-[640px] shadow-md mx-auto mt-16 mb-5 w-full
             md:w-10/12'
              >
                <div className="p-4">
                  <div
                    ...
                    <div className="flex items-start">
                      <div className="w-12 h-12  m-2">
                        ...
                        <img
                          ...
                          src={post.userProfileImage || userDetails.profilePic}
                          alt="Profile"
                        />
                      </div>
                      <div>
                        ...
                        <p className="text-xs text-gray-600">
                          {post.userRole || userDetails.role}
                        </p>
                  ...
                  <p className=" whitespace-pre text-gray-700 text-base font-normal my-2">
                    {post.content}
                  </p>
