...
export default function ChatPage() {
  ...
  if (!decryptedID) {
    console.error('Error: Unable to decrypt user ID');
    return <div>Error loading chat. Please try again.</div>;
  }

  console.log('Decrypted User ID:', decryptedID); // Debug log for decryptedID

  const { userData } = useAuth(); // Authenticated user data
  console.log('Authenticated User Data:', userData); // Debug log for userData
  ...
  console.log('Chat ID:', chatId); // Debug log for chatId
